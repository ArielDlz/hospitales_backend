export interface ActivarCuentaEmailParams {
  nombre: string;
  apellidos: string;
...
const SUBJECT = 'Activa tu cuenta en la plataforma de pruebas psicométricas';

const PLATFORM_TITLE =
  'Plataforma de pruebas psicométricas de Psique y Cultura';

export function buildActivarCuentaEmail(
  params: ActivarCuentaEmailParams,
): ActivarCuentaEmailContent {
  const {
    nombre,
    apellidos,
    telefono,
  ...
  const text = [
    ...
    `Hola, ${nombre}`,
    '',
    'Recibimos una solicitud para activar tu cuenta en la plataforma de aplicación de pruebas psicométricas de Psique y Cultura. Para confirmar tu identidad, establecer tu contraseña y completar tu registro, haz clic en el siguiente enlace:',
    '',
    activacionUrl,
    '',
    'Aquí están los datos asociados a tu registro:',
    '',
    `Nombre(s): ${nombre}`,
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <p style="margin:0 0 24px;font-size:16px;line-height:1.5;">
                Recibimos una solicitud para activar tu cuenta en la plataforma de aplicación de pruebas psicométricas de Psique y Cultura.
                Para confirmar tu identidad, establecer tu contraseña y completar tu registro, haz clic en el botón siguiente:
              </p>
